...
public static class TrackCircultBuilder
{
    ...
    private static void ResetPoints(Transform trackTransforn, TrackPoint[] points)
    {
        for (int i = 0; i < points.Length; i++)
        {
            points[i] = trackTransforn.GetChild(i).GetComponent<TrackPoint>();
    ...
    private static void MakeLinks(TrackPoint[] points, TrackType type)
    {
        ...
        {
            points[^1].Next = points[0]; // points.Length - 1 => ^1
        }
    }
